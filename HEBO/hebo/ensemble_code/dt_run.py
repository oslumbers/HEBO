...
if __name__ == '__main__':
    ...
    for i in range(seeds):
        ...
        result, report = tuner(DecisionTreeClassifier, space_cfg, X, y, metric = mean_squared_error, greater_is_better=False, max_iter = 3, num_ens=args.num_ens)
        print(f'result: {result}')
        seed_res.append(report)
    # Dump the report to a pickle file
    save_dir = f'results_testing/decision_tree/{args.dataset}'
